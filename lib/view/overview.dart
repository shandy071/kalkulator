    ...
    return Row(
      ...
      children: <Widget>[
        ...
        new FlatButton(
          ...
          child: new Icon(Icons.backspace, size: 35, color: Colors.blueGrey),
        ),
        new FlatButton(
          padding: const EdgeInsets.all(18.0),
          textColor: Colors.blueGrey,
            ...
            bottom: PreferredSize(
              ...
              child: Theme(
                data: Theme.of(context)
                    .copyWith(accentColor: Color.fromARGB(255, 253, 253, 253)),
                child: Container(
                    height: 60,
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                launch("https://www.dicoding.com/users/127809"),
                          )
                        ],
                      ),
                    )),
